...
namespace Lawo.EmberPlusSharp.Glow
{
    ...
    internal static class GlowQualifiedMatrix
    {
        internal const int InnerNumber = Ember.InnerNumber.FirstApplication + 17;
        internal const string Name = "QualifiedMatrix";
        ...
        internal static class Connections
        {
            ...
            internal const string Name = "connections";
