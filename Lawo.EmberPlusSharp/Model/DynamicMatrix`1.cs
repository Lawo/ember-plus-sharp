...
namespace Lawo.EmberPlusSharp.Model
{
    ...
    /// <summary>Represents a matrix with dynamic and optional static children in the object tree accessible
    ...
    /// accessed as described in the <see cref="Matrix{T}"/> class remarks. Dynamic children are accessible through
    /// the collection exposed by <see cref="DynamicChildren"/>.</remarks>
    /// <threadsafety static="true" instance="false"/>
    [SuppressMessage("Microsoft.Maintainability", "CA1501:AvoidExcessiveInheritance", Justification = "Fewer levels of inheritance would lead to more code duplication.")]
    public abstract class DynamicMatrix<TMostDerived> : DynamicMatrixBase<TMostDerived>
        where TMostDerived : DynamicMatrix<TMostDerived>
    {
        /// <summary>Gets the dynamic children of this matrix.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="DynamicMatrix{TMostDerived}"/> class.</summary>
        /// <remarks>
