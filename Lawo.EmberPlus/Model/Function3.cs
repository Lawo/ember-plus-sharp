...
namespace Lawo.EmberPlus.Model
{
    ...
    /// <summary>Represents a function accepting three arguments in the object tree accessible through
        ...
        where TResult : ResultBase<TResult>, new()
    {
        ...
        /// <see cref="InvokeAsync(T1, T2, T3)">InvokeAsync(<paramref name="arg1"/>, <paramref name="arg2"/>,
        /// <paramref name="arg3"/>)</see>.</summary>
        [Obsolete("Call InvokeAsync instead.")]
        public Task<TResult> Invoke(T1 arg1, T2 arg2, T3 arg3)
        {
            return this.InvokeAsync(arg1, arg2, arg3);
        }
