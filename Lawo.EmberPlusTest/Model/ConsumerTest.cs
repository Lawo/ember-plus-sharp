...
namespace Lawo.EmberPlus.Model
{
    ...
    using Lawo.EmberPlus.Model.Test;
            ...
            AsyncPump.Run(
                async () =>
                {
                    ...
                    await AssertThrowAfterFirstRequest<ModelException, SingleNodeRoot>(
                        ...
                        "No data value available for the required property Lawo.EmberPlus.Model.Test.SingleNodeRoot.FieldNode in the node with the path /.");
                    await AssertThrowAfterFirstRequest<ModelException, SingleNodeRoot>(
                        "NoDataValueAvailableReponse2.xml",
                        "No data value available for the required property Lawo.EmberPlus.Model.Test.RecursiveFieldNode.SomeParameter in the node with the path /FieldNode/FieldNode.");
                    await AssertThrowAfterFirstRequest<ModelException, DuplicateElementRoot>(
                        "DuplicateElementResponse1.xml",
                        "Duplicate identifier found in Lawo.EmberPlus.Model.Test.DuplicateElementRoot.");
                    ...
                    await AssertThrowAfterFirstRequest<ModelException, UnsupportedPropertyTypeRoot>(
                        ...
                        "The property Whatever in the type Lawo.EmberPlus.Model.Test.UnsupportedPropertyTypeRoot has an unsupported type.");
                    ...
                    await AssertThrowInCreateAsync<ModelException, UnsupportedTypeInFunctionRoot1>(
                        ...
                        "Unsupported type in function signature Lawo.EmberPlus.Model.Function`2[System.Char,Lawo.EmberPlus.Model.Result`1[System.Int64]].");
                    await AssertThrowInCreateAsync<ModelException, UnsupportedTypeInFunctionRoot2>(
                        "UnaryFunctionLog.xml",
                        "Unsupported type in function signature Lawo.EmberPlus.Model.Function`2[System.Int32,Lawo.EmberPlus.Model.Result`1[System.Char]].",
                        false);
                    ...
                    await AssertThrowInCreateAsync<ModelException, ZoneNodeRoot>(
                        ...
                        "The required property Lawo.EmberPlus.Model.Test.ZoneNode.Ravenna in the node with the path /ZoneNode has been set offline by the provider.");
